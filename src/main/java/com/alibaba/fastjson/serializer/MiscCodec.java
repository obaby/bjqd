...
public class MiscCodec implements ObjectSerializer, ObjectDeserializer {
    private static boolean FILE_RELATIVE_PATH_SUPPORT = RequestConstant.TRUE.equals(IOUtils.getStringProperty("fastjson.deserializer.fileRelativePathSupport"));
                        ...
                        if (name.equals("java.nio.file.Path")) {
                            try {
                                ...
                                if (method_paths_get != null) {
                                    return method_paths_get.invoke((Object) null, new Object[]{str, new String[0]});
                                }
