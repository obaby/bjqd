...
public final class a {
    ...
    private static final int f684a = 128;

    /* renamed from: b  reason: collision with root package name */
    private static final int f685b = 64;

    /* renamed from: c  reason: collision with root package name */
    private static final int f686c = 24;
    ...
    static {
        ...
        int i7 = BuildConfig.VERSION_CODE;
        while (true) {
            i2 = 26;
            if (i7 < 97) {
                break;
    ...
    public static String a(byte[] bArr) {
        ...
        while (i4 < i3) {
            ...
            byte b5 = (byte) (b3 & 15);
            byte b6 = (byte) (b2 & 3);
            byte b7 = (byte) ((b2 & Byte.MIN_VALUE) == 0 ? b2 >> 2 : (b2 >> 2) ^ Opcodes.CHECKCAST);
        ...
        if (i2 == 8) {
            ...
            byte b11 = (byte) (b10 & 3);
            int i13 = i6 + 1;
            cArr[i6] = j[(byte) ((b10 & Byte.MIN_VALUE) == 0 ? b10 >> 2 : (b10 >> 2) ^ Opcodes.CHECKCAST)];
            int i14 = i13 + 1;
            cArr[i13] = j[b11 << 4];
            cArr[i14] = h;
            cArr[i14 + 1] = h;
            ...
            byte b15 = (byte) (b12 & 3);
            byte b16 = (byte) ((b12 & Byte.MIN_VALUE) == 0 ? b12 >> 2 : (b12 >> 2) ^ Opcodes.CHECKCAST);
