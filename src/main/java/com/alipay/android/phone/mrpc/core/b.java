...
public final class b implements HttpClient {
    ...
    public static long f514a = 160;

    /* renamed from: b  reason: collision with root package name */
    private static String[] f515b = {"text/", "application/xml", "application/json"};
    /* access modifiers changed from: private */

    /* renamed from: c  reason: collision with root package name */
    public static final HttpRequestInterceptor f516c = new c();
    private final HttpClient d;
    private RuntimeException e = new IllegalStateException("AndroidHttpClient created and never closed");
    /* access modifiers changed from: private */
    public volatile C0010b f;
    ...
    private class a implements HttpRequestInterceptor {
        ...
        public final void process(HttpRequest httpRequest, HttpContext httpContext) {
            C0010b a2 = b.this.f;
            if (a2 != null && Log.isLoggable(a2.f518a, a2.f519b) && (httpRequest instanceof HttpUriRequest)) {
                Log.println(a2.f519b, a2.f518a, b.a((HttpUriRequest) httpRequest));
            }
        }
    }
    ...
    public static InputStream a(HttpEntity httpEntity) {
        ...
        return (content == null || (contentEncoding = httpEntity.getContentEncoding()) == null || (value = contentEncoding.getValue()) == null) ? content : value.contains(HttpConstant.GZIP) ? new GZIPInputStream(content) : content;
    }
    ...
    private static boolean b(HttpUriRequest httpUriRequest) {
        ...
        if (headers != null) {
            for (Header value : headers) {
                if (HttpConstant.GZIP.equalsIgnoreCase(value.getValue())) {
                    return true;
                }
            }
        }
