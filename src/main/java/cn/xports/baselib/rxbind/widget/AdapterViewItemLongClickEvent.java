...
public final class AdapterViewItemLongClickEvent {
    ...
    public static /* synthetic */ AdapterViewItemLongClickEvent copy$default(AdapterViewItemLongClickEvent adapterViewItemLongClickEvent, AdapterView<?> adapterView, View view2, int i, long j, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return adapterViewItemLongClickEvent.copy(adapterView, view3, i3, j);
    }
    ...
    @NotNull
    public final AdapterViewItemLongClickEvent copy(@NotNull AdapterView<?> adapterView, @Nullable View view2, int i, long j) {
        Intrinsics.checkParameterIsNotNull(adapterView, "view");
        return new AdapterViewItemLongClickEvent(adapterView, view2, i, j);
    }
    ...
    public AdapterViewItemLongClickEvent(@NotNull AdapterView<?> adapterView, @Nullable View view2, int i, long j) {
        Intrinsics.checkParameterIsNotNull(adapterView, "view");
