...
public final class SportCoachingListActivity$showListData$$inlined$sortedByDescending$1<T> implements Comparator<T> {
    public final int compare(T t, T t2) {
        return ComparisonsKt.compareValues(((DateList) t2).createTime, ((DateList) t).createTime);
    }
}
