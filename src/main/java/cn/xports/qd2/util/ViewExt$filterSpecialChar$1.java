...
final class ViewExt$filterSpecialChar$1 implements InputFilter {
    public static final ViewExt$filterSpecialChar$1 INSTANCE = new ViewExt$filterSpecialChar$1();

    ViewExt$filterSpecialChar$1() {
    }
