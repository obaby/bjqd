...
public class CreditGoods2Adapter extends XBaseAdapter<DataMap> {
    public CreditGoods2Adapter(List<DataMap> list) {
        super(list);
    }

    public int getLayoutId() {
        return R.layout.item_credit_goods2;
    }
    ...
    public void onBindViewHolder(@NonNull XBaseHolder xBaseHolder, final int i) {
        ...
        xBaseHolder.itemView.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                CreditGoods2Adapter.this.performItemClick(dataMap, i);
            }
        });
    }
}
