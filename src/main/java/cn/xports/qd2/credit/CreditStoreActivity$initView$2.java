...
final class CreditStoreActivity$initView$2 implements View.OnClickListener {
    final /* synthetic */ CreditStoreActivity this$0;

    CreditStoreActivity$initView$2(CreditStoreActivity creditStoreActivity) {
        this.this$0 = creditStoreActivity;
    }

    public final void onClick(View view) {
        CreditStoreActivity creditStoreActivity = this.this$0;
        Bundle bundle = ViewExt.set(new Bundle(), d.p, 1);
        String json = GsonUtils.toJson(this.this$0.coupons);
        Intrinsics.checkExpressionValueIsNotNull(json, "GsonUtils.toJson(coupons)");
