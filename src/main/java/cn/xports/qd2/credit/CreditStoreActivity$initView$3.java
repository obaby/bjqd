...
final class CreditStoreActivity$initView$3<T> implements XBaseAdapter.OnItemClickListener<DataMap> {
    final /* synthetic */ CreditStoreActivity this$0;

    CreditStoreActivity$initView$3(CreditStoreActivity creditStoreActivity) {
    ...
    public final void onItemClick(DataMap dataMap, int i, int i2) {
        ...
        Bundle bundle = ViewExt.set(new Bundle(), "exchange_type", 1);
