...
final class MyCreditActivity$getCreditDetails$2 extends Lambda implements Function1<DataMap, Unit> {
    final /* synthetic */ MyCreditActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    MyCreditActivity$getCreditDetails$2(MyCreditActivity myCreditActivity) {
        super(1);
