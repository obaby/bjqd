...
final class CreditRuleActivity$getRule$2 extends Lambda implements Function1<DataMap, Unit> {
    final /* synthetic */ CreditRuleActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    CreditRuleActivity$getRule$2(CreditRuleActivity creditRuleActivity) {
        super(1);
