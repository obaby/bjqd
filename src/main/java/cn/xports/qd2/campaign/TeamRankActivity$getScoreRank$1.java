...
final class TeamRankActivity$getScoreRank$1 extends Lambda implements Function1<DataMap, Unit> {
    final /* synthetic */ TeamRankActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    TeamRankActivity$getScoreRank$1(TeamRankActivity teamRankActivity) {
        super(1);
        this.this$0 = teamRankActivity;
    }
