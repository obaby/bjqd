...
final class PostDetailActivity$deleteComment$1 extends Lambda implements Function1<DataMap, Unit> {
    final /* synthetic */ PostDetailActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PostDetailActivity$deleteComment$1(PostDetailActivity postDetailActivity) {
        super(1);
