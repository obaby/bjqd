...
final class CircleLikePresenter$addLike$2 extends Lambda implements Function1<DataMap, Unit> {
    final /* synthetic */ CircleLikePresenter this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    CircleLikePresenter$addLike$2(CircleLikePresenter circleLikePresenter) {
        super(1);
