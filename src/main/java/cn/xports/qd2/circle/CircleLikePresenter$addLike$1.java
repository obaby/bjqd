...
final class CircleLikePresenter$addLike$1 extends Lambda implements Function1<DataMap, Unit> {
    final /* synthetic */ CircleLikePresenter this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    CircleLikePresenter$addLike$1(CircleLikePresenter circleLikePresenter) {
        super(1);
    ...
    public final void invoke(@NotNull DataMap dataMap) {
        ...
        this.this$0.iView.optionSuccess(1);
    }
}
