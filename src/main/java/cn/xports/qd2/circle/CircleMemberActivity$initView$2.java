...
final class CircleMemberActivity$initView$2 implements View.OnClickListener {
    final /* synthetic */ CircleMemberActivity this$0;

    CircleMemberActivity$initView$2(CircleMemberActivity circleMemberActivity) {
    ...
    public final void onClick(View view) {
        ...
        access$getMTvRight$p.setVisibility(8);
        ...
        access$getMIvRight$p.setVisibility(0);
        ...
        this.this$0.adapter.setCanSelect(false).notifyDataSetChanged();
    }
}
