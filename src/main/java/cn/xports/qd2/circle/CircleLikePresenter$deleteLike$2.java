...
final class CircleLikePresenter$deleteLike$2 extends Lambda implements Function1<DataMap, Unit> {
    final /* synthetic */ CircleLikePresenter this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    CircleLikePresenter$deleteLike$2(CircleLikePresenter circleLikePresenter) {
        super(1);
    ...
    public final void invoke(@NotNull DataMap dataMap) {
        ...
        CircleLikeView access$getIView$p = this.this$0.iView;
        String message = dataMap.getMessage();
        Intrinsics.checkExpressionValueIsNotNull(message, "it.message");
        access$getIView$p.optionFail(message);
    }
}
