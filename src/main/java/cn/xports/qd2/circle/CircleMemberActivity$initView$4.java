...
final class CircleMemberActivity$initView$4<T> implements XBaseAdapter.OnItemClickListener<DataMap> {
    final /* synthetic */ CircleMemberActivity this$0;

    CircleMemberActivity$initView$4(CircleMemberActivity circleMemberActivity) {
    ...
    public final void onItemClick(DataMap dataMap, int i, int i2) {
        if (i2 == 1) {
            ...
            circleMemberActivity.setRole(dataMap);
        }
    }
}
