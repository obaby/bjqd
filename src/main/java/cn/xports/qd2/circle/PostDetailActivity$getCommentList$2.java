...
final class PostDetailActivity$getCommentList$2 extends Lambda implements Function1<DataMap, Unit> {
    final /* synthetic */ PostDetailActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PostDetailActivity$getCommentList$2(PostDetailActivity postDetailActivity) {
        super(1);
    ...
    public final void invoke(@NotNull DataMap dataMap) {
        ...
        this.this$0.showMsg(dataMap.getMessage());
