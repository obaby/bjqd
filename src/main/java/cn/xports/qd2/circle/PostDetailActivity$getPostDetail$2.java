...
final class PostDetailActivity$getPostDetail$2 extends Lambda implements Function1<DataMap, Unit> {
    final /* synthetic */ PostDetailActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PostDetailActivity$getPostDetail$2(PostDetailActivity postDetailActivity) {
        super(1);
