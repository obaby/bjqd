...
final class TrainingFragment$initView$3 implements DropDownView.OnItemSelectListener {
    final /* synthetic */ TrainingFragment this$0;

    TrainingFragment$initView$3(TrainingFragment trainingFragment) {
    ...
    public final void OnItemSelect(Option<Object> option, int i) {
        ...
        trainingFragment.suitPerson = value;
