...
final class TrainingFragment$initView$2 implements DropDownView.OnItemSelectListener {
    final /* synthetic */ TrainingFragment this$0;

    TrainingFragment$initView$2(TrainingFragment trainingFragment) {
    ...
    public final void OnItemSelect(Option<Object> option, int i) {
        ...
        trainingFragment.serviceId = value;
