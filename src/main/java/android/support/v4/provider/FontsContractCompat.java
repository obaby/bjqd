        ...
        try {
            ...
            if (cursor != null && cursor.getCount() > 0) {
                ...
                while (cursor.moveToNext()) {
                    ...
                    arrayList2.add(new FontInfo(withAppendedId, i2, columnIndex5 != -1 ? cursor.getInt(columnIndex5) : BuildConfig.VERSION_CODE, columnIndex6 != -1 && cursor.getInt(columnIndex6) == 1, i));
                }
