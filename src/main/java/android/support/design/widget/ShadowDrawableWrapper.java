...
class ShadowDrawableWrapper extends DrawableWrapper {
    ...
    private void buildShadowCorners() {
        ...
        if (f > 0.0f) {
            ...
            RadialGradient radialGradient2 = new RadialGradient(0.0f, 0.0f, f, new int[]{0, this.mShadowStartColor, this.mShadowMiddleColor, this.mShadowEndColor}, new float[]{0.0f, f2, ((SHADOW_BOTTOM_SCALE - f2) / 2.0f) + f2, 1.0f}, Shader.TileMode.CLAMP);
