        ...
        private static class Proxy implements Connection {
            ...
            public ParcelableInputStream getInputStream() throws RemoteException {
                ...
                try {
                    ...
                    this.f349a.transact(1, obtain, obtain2, 0);
            ...
            public int getStatusCode() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.f349a.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public String getDesc() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.f349a.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public Map getConnHeadFields() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.f349a.transact(4, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public StatisticData getStatisticData() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.f349a.transact(5, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public void cancel() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.f349a.transact(6, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
