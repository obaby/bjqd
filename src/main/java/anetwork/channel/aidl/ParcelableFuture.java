        ...
        private static class Proxy implements ParcelableFuture {
            ...
            public boolean cancel(boolean z) throws RemoteException {
                ...
                try {
                    ...
                    boolean z2 = false;
                    this.f364a.transact(1, obtain, obtain2, 0);
            ...
            public boolean isCancelled() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    boolean z = false;
                    this.f364a.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
                    if (obtain2.readInt() != 0) {
                        z = true;
                    }
            ...
            public boolean isDone() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    boolean z = false;
                    this.f364a.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
                    if (obtain2.readInt() != 0) {
                        z = true;
                    }
            ...
            public NetworkResponse get(long j) throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    obtain.writeLong(j);
                    this.f364a.transact(4, obtain, obtain2, 0);
                    obtain2.readException();
