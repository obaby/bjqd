        ...
        private static class Proxy implements ParcelableInputStream {
            ...
            public int available() throws RemoteException {
                ...
                try {
                    ...
                    this.f365a.transact(1, obtain, obtain2, 0);
            ...
            public void close() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.f365a.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public int readByte() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.f365a.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
                    return obtain2.readInt();
                } finally {
                    obtain2.recycle();
            ...
            public int readBytes(byte[] bArr, int i, int i2) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    obtain.writeInt(i2);
                    this.f365a.transact(4, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public int read(byte[] bArr) throws RemoteException {
                ...
                try {
                    ...
                    this.f365a.transact(5, obtain, obtain2, 0);
                    obtain2.readException();
                    int readInt = obtain2.readInt();
                    obtain2.readByteArray(bArr);
                    return readInt;
            ...
            public long skip(int i) throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    obtain.writeInt(i);
                    this.f365a.transact(6, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public int length() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.f365a.transact(7, obtain, obtain2, 0);
                    obtain2.readException();
                    return obtain2.readInt();
                } finally {
                    obtain2.recycle();
